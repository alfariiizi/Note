...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.5.8.js", main: "static.adsafeprotected.com/main.19.8.217.js"},
		protocol: 'https',
		jsref: "https:\/\/03c0cdc0ab5448098992cd7db694102e.safeframe.googlesyndication.com\/",
		asid: "03971353-e77e-11eb-aed5-0ab6eda18616",
		...
		mode: "rjss",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=741863",
		adsafeSrc: "https:\/\/fw.adsafeprotected.com\/rfw\/www.googletagservices.com\/741863\/55359962\/dcm\/dcmads.js",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/fw.adsafeprotected.com\/rjss\/www.googletagservices.com\/741863\/55359962\/dcm\/dcmads.js",
		accountForSadImps: '',
		fwMonitoring: 'false',
		mn: "app05sg",
		mobOrTab: false,
		app: false,
		mobAppWebview: false,
		mobFwUrl: "https:\/\/mobile.adsafeprotected.com\/internal\/blocking\/app\/initial\/741863\/55359962?redirectUrl=https%3A%2F%2Fwww.googletagservices.com%2Fdcm%2Fdcmads.js",
		anId: '',
		advEntityId: '741863',
		pubEntityId: '55359962',
		videoId: '',
		rts: {},
		customViewability: [],
...
a.hasValidDimensions)}}},bd=function(){var a=ad(),b=function(a,b){b.tag=s.getTagName(a);b.size=s.getDimensionFromAttributes(a)||s.getDimensionFromStyle(a)};return{getDFPValue:function(c){var d;if(d=a.getDFPGoogleDiv(c)){var e;c={type:0};if(d)if(c.type=1,e=a.getClickableImage(d))c.type=2,b(e,c);else if(d=a.getNodeMatchingMinimumSize(d))c.type=3,b(d,c);d=c}else if(d={type:0},c=a.getNodeMatchingMinimumSize(c))d.type=4,b(c,d);return d}}},qc={name:"viewport",dependencies:[],creator:function(){var a={width:4,
...
a),k=function(){g.isUndef(d)&&(d=new jd(e));return d},l=function(){e.provide({frameCollection:function(){return p},adProxy:function(){return q},adTalkMessage:function(a){return new kd(a,e)},adTalkMessageCollection:function(){return m},idMapModule:k,interFrameQuerySelector:function(a){return new ld(a)}})};return{isApplicable:function(a){return g.isDef(v.JSON)&&g.isDef(v.postMessage)&&!a.isAvid()&&(!a.isOmidNative()||a.isOmidForWeb())},start:function(){l();f.traverse(p.addFrame);u.startListening();
...
c=n.getAggregator().request("features").on("swapids")?l.oid:l.asid;var f=a||{},g=l.asid,d=d.tagId,m=t.embedded,q=t.friendly,u=l.birthdate;c=c.split("-")[2];var w;t.friendly?w="["+k.AD_IDENTIFIER+"-"+l.asid+"]":(w=r.getWindow(),w=w.location&&w.location.href,w='iframe[src*="'+(w&&w.replace(/^https?\:\/\//i,""))+'"]');return{messageContent:f,srcAsid:g,srcTagId:d,srcIsEmbedded:m,srcIsFriendly:q,srcBirthdate:u,iasCommonId:c,nodeSelector:w,positionStr:e,version:"0.1"}},gd=function(){var a={};return{add:function(b){var c=
...
[],c={},d={noMe:!0};return{addFrame:function(e,f,g){var m=a.request("adProxy").getAll();e=new md(e,f,m,g);b.push(e);c[e.id]=e;e.isMe&&(d=e);return e},getFrame:function(a){return c[a]},list:b,dictionary:c,getMe:function(){return d}}},Na=function(a,b){var c=function(a,c){var g=c.adProxies,m="";if(c.isValidForMapping()){if(b)m+=d(g,c.getStringifiedPosition());else{var q;q=""+c.getStringifiedPosition();q+=c.isMe?"*":"";q+=g.length?"."+g[0].tagId:"";m+=q}return m}},d=function(a,b){var c="";return c=a.length?
...
c)},m=function(c,d,e){var f,m,l,H,t;try{f=a.request("frameCollection");m=a.request("adTalkMessageCollection");l=d.messageContent.self;m.add(d);var C=f.getMe();C.unifiedId>l.unifiedId&&(C.unifiedId=l.unifiedId);var s;s=r.now()-d.sentTime;d.transferDuration=s;m=H=f.getFrame(l.id);g.isUndef(m)||g.isUndef(m.selfDescription)?(H=H||f.addFrame(c.source,l.id.split("-"),d),H.addInformationFromSrc(d,l),e()):H.addInformationFromSrc(d,l);(t=b&&a.request("idMapModule").isCandidateForMyIdMap(d))&&p()}catch(v){n.getAggregator().trigger("error",
k.ERROR_CODES.ADTALK_DUBIOUS)}};return{sendAdTalkCall:p,sendToKnownFrames:function(){(new da).send(f)},startListening:function(){c=new Ea;c.listen(e,m,f)},stopListening:function(){c&&c.stop()},validateMessage:e,processMessage:m,createMessage:f}},nd=function(){var a=n.getAggregator().request("ids"),b=a.getAsid();return{tagId:a.getFwId(),adSafeId:b}},hd=function(){var a,b=[],c=function(a){a=new nd(a);b.push(a);return a};a=c();return{createNew:c,getAll:function(){return b},myIdCard:a}},Sb=function(a){var b,
c,d=!1,e=function(a){var e=!0;d&&(d=!1,a.stopPropagation?(a.stopPropagation(),a.preventDefault()):a.cancelBubble=!0,b=a.screenX-a.clientX,c=a.screenY-a.clientY,e=!1);return e};a.browserIs(k.BROWSERS.IE)&&z.addEvent(r.getDoc().documentElement,"click",e,!0);return{determineFramePosition:function(){a.browserIs(k.BROWSERS.IE)&&(d=!0,r.getDoc().documentElement.click());return{scrX:b,scrY:c}}}},od=function(a,b){var c,d,e=k.NA,f=e,p=!1,m=!1,q=!1,u=!b,l=n.getAggregator().request("browser"),y=function(a,b){Ic().applies(l)&&
r.getResizeObserver(function(c,d){var e=c.pop();0<e.contentRect.height*e.contentRect.width&&(b.unobserve(a),b.observe(a),d.disconnect())}).observe(a)},A=function(){var b=r.getIntersectionObserver(function(a,b){var d=a.pop(),g=d.intersectionRect.width*d.intersectionRect.height/(d.boundingClientRect.width*d.boundingClientRect.height)*100;isNaN(g)&&(y(d.target,b),g=0);e=Math.min(g,100);c=d.boundingClientRect;e!==f&&r.execAtEndOfThread(function(){n.getAggregator().trigger("IOPivChange",e)});f=e},{threshold:k.VIEWABILITY_IN_VIEW_THRESHOLDS_INTERSECTION_OBSERVER});
u&&r.execAtEndOfThread(function(){e===k.NA&&(e=0)});b.observe(x(a));u&&r.execAtEndOfThread(function(){t.isBustedIframe()||n.getAggregator().trigger("delayedViewabilityReady")});p=!0},x=function(b){if(!g.isUndef(b)){if(q){b=a.document;var c=b.createElement("div");g(c.style).mixin({position:"absolute",width:"100%",opacity:"0",height:"100%",zIndex:-999,top:"0px",left:"0px"});c[k.IAS_DETECTOR]=!0;b.body.appendChild(c);b=c}return d=b}};return{start:function(){var b;try{a.document&&(q=!0,b={bodyElement:a.document.body,
document:a.document})}catch(c){m=!0}b&&null!==b.bodyElement?A():b&&b.document?z.whenReady(A,b.document):m?n.getAggregator().request("errors").add(k.ERROR_CODES.BUSTED_IFRAME_IN_IO):A()},isReady:function(){return e!==k.NA},isStarted:function(){return p},getAdNodeDimensions:function(){var a;c&&(a=D({scrX:void 0,scrY:void 0,width:c.width,height:c.height}));return a},getObservedNode:function(){return d},getPiv:function(){return e}}},ta=function(){var a=!1;(function(){z.whenReady(function(){n.getAggregator().trigger("startViewabilityLoop");
...
a.type+"|"))try{var m="",u=a.hasOwnProperty("timestamp")?a.timestamp:(new Date).getTime(),w=u-(l.birthdate||u+1),y="n",x=!1;switch(a.type){case "start":m="adVideoStart";q.videoStartArrived=!0;n.getAggregator().trigger("omidrendvideostart");d=u;f=a.data.duration;1E3<f&&(f/=1E3);e=a.data.videoPlayerVolume;break;case "volumeChange":m="volumeChanged";e=a.data.videoPlayerVolume;break;case "firstQuartile":case "midpoint":case "thirdQuartile":case "complete":m="adVideo"+a.type.substring(0,1).toUpperCase()+
a.type.substring(1);x=!0;n.getAggregator().trigger("videoQuartileEvent",a);break;case "pause":case "bufferStart":m="pauseAd";break;case "resume":case "bufferFinish":m="resumeAd";break;case "skipped":m="adSkipped"}if(""!==m){var r=n.getAggregator().request("mScreenEvents");r&&(y=r.getCurrentLoc());c.push({t:u-d,rt:w,tp:m,sl:y,ad_duration:f,volume:e})}if("loaded"===a.type&&g.isDef(a.data)){var A=["preroll","midroll","postroll","standalone"].indexOf(a.data.position),m=-1!==A?A+1:void 0,u=[];!0===a.data.autoPlay?
...
z,v.bootstrapper)}};return{start:function(){n.getAggregator().on("impressionsent",A);n.getAggregator().provide({omidVideoEventsString:y});w.addEventListener("video",x);m.init()},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",a)}}},Oa=function(a,b){var c=!1,d=function(a){var d=a.percentageInView;c=!0;a.viewState=50<=d?k.IN_VIEW:k.OUT_OF_VIEW;a.outOfViewReason=50<=d?"":k.OUT_OF_VIEW_REASONS.GEOM;b.trigger("measurementChanged",a)};return{start:function(){n.getAggregator().trigger("addOutputItem",
...
c)},addAdContainerGeometryMeasurementChangedListener:function(a){b.on(k.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,a)},translateAvidOutOfViewReasons:d}},Ra=function(a,b,c){function d(a,b,c){c=m(b,c);a=f(a,b,c);return a.width*a.height}var e=function(a,b){var c=Math.max(a.x,b.x),d=Math.max(a.y,b.y),e=Math.min(a.x+a.width,b.x+b.width),f=Math.min(a.y+a.height,b.y+b.height),e=e-c,f=f-d;return{x:c,y:d,width:0<e?e:0,height:0<f?f:0}},f=function(a,b,c){a=e(b,a);return e(c,{x:0,y:0,width:a.width,height:a.height})},
p=function(a,b){return{x:a.x+b.x,y:a.y+b.y,width:b.width,height:b.height}},m=function(a,b){return{x:b.x-a.x,y:b.y-a.y,width:b.width,height:b.height}};return{calculateGeometricMeasurement:function(e,l){if(g.isDef(e)&&g.isDef(l)){var n=e.viewport,y=e.computedAdContainer,A=y.obstructions,x=e.omidObstructions,t=A&&0<A.length,s=e.originalAdContainer,C=l.adGeometry,v=l.adFound,z=e.detectionMethod,F=0,n={x:0,y:0,width:n.width,height:n.height},G=p(s,C),S=e.outOfViewReason,L=0,N=0,B=t||!1,L=1>=C.width*C.height;
c&&L&&(v=!1,S=S||"",v||-1!==S.indexOf(k.OUT_OF_VIEW_REASONS.GEOM)||(S=k.OUT_OF_VIEW_REASONS.GEOM+(""!==S?"."+S:"")));if(v&&0<e.percentageInView){L=d(n,y,G);t?(F=m(y,G),F=f(n,y,F),F=p(y,F),F=a.calculateObstructedArea(F,A)):F=0;N=F;F=Math.round((L-N)/(G.width*G.height)*100);t&&0===N&&(B=!1);for(var C=(new D(G)).getRoundedGeometry(),v=B,M,t=0,N=b.getConfig(C).numberOfSlices,T=r.floor(C.height/N)||1,A=[],L=v?a.getObstructionStatusBySlice(N):[],Da,t=0;t<N;t++)M=C.y+T*t,t==N-1&&(T=C.y+C.height-M),M={x:C.x,
y:M,width:C.width,height:T},Da=d(n,y,M),M=1==Da/(M.width*M.height),A.push(M);if(v)for(y=r.min(L.length,N),t=0;t<y;t++)A[t]=A[t]&&!L[t];y=A}else y=b.getConfig(C).defaultSliceArray;s={windowDimensions:n,containerDimensions:s,adDimensions:G,percentageInView:F,viewState:50<=F?k.IN_VIEW:k.OUT_OF_VIEW,outOfViewReason:50<=F?"":S||k.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:z,isObstructed:B,sliceStatus:y};g.isDef(x)&&""!==x&&(s.omidObstructions=x);return s}}}},Hd=function(){return{accepts:function(){return t.isAvidNative()}}},
...
a)},getStrategyName:function(){return k.MEASUREMENT_STRATEGY.DISPLAY},isMeasurable:function(){return p}}},Sa=function(a){var b=[],c;return{calculateObstructedArea:function(d,e){var f,p,m,q;p=e&&0<e.length;var k;if(p){k=Math.round(d.width);var l=Math.round(d.height);f=Array(k);for(m=0;m<k;m++)f[m]=Array(l);k={matrix:f,obscuredPixelCount:0,x:Math.round(d.x),y:Math.round(d.y),width:k,height:l}}else k={};f=k;l=k=0;if(p){for(;k<e.length;k++){p=e[k];m=l=f;var n=p;f=Math.max(m.x,n.x);p=Math.max(m.y,n.y);
...
"browser"],creator:function(a,b,c,d){var e,f=Rd(c),p=[new Sd,new Td(f)],m=function(){return g(p).findFirst(function(a,e){return e.applies(d,b,c)?e:void 0})},q=function(a){"sessionFinish"===a.type&&(n.getAggregator().trigger("addOutputItem",{output:t.getTagTime()},"osef"),n.getAggregator().trigger("adSessionComplete"))},u=function(a){z.addEvent(v,a,function(){n.getAggregator().trigger("adSessionComplete")},!1)},w=function(){var a=new Y(k.DT_CODES.VIDEO_EVENTS);n.getAggregator().trigger("sendDt",a.callType,
